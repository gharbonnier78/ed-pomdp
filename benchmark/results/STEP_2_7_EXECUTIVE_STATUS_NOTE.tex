...
Four acquisition budgets were used, with 30 frozen seeds and the same latent scenarios for every policy. Rules, endpoints, parameters, bootstrap and permutation counts, and multiplicity correction were locked before execution. The reviewer then independently checked the hashes and row counts and reimplemented Holm step-down with \textbf{zero discrepancies across all 240 adjusted values}.
